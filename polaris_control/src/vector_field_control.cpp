...
private:
    ...
    void updateRobotPose(double x, double y, double z, const geometry_msgs::msg::Quaternion& q) {
        ...
        mat.getRPY(robot_euler_angles_[0], robot_euler_angles_[2], robot_euler_angles_[1]);
        robot_euler_angles_[1] = -robot_euler_angles_[1]; // Negate yaw to match coordinate conventions
    }
